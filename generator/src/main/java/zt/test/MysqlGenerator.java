...
import zt.generator.AutoGenerator;
import zt.generator.InjectionConfig;
import zt.generator.config.*;
import zt.generator.config.converts.MySqlTypeConvert;
import zt.generator.config.po.TableInfo;
import zt.generator.config.rules.DbColumnType;
import zt.generator.config.rules.DbType;
import zt.generator.config.rules.NamingStrategy;
...
public class MysqlGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/test?characterEncoding=utf8&useUnicode=true&serverTimezone＝UTC&useSSL=true");
        ...
        // 自定义 mapper 父类
        // strategy.setSuperMapperClass("zt.generator.TestMapper");
        // 自定义 service 父类
        ...
        pc.setParent("zt.generator");// 自定义包路径
