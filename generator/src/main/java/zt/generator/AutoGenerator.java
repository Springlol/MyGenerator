...
import zt.generator.config.ConstVal;
import zt.generator.config.FileOutConfig;
import zt.generator.config.StringUtils;
import zt.generator.config.TemplateConfig;
import zt.generator.config.builder.ConfigBuilder;
...
//					logger.debug("创建目录： [" + entry.getValue() + "]");
                    System.out.println("创建目录： [" + entry.getValue() + "]");
...
//			logger.error("无法创建文件，请检查配置信息！", e);
            System.out.println("无法创建文件，请检查配置信息！" + e);
        }
    }
